...
var fileAdapter = require('skipper-gridfs')({uri: 'mongodb://127.0.0.1:27017/gameplan.fs' }); // create an instance of the adapter that handles file uploads/downloads from the MongoDB GridFS
